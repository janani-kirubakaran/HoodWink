...
<div class="row">
<div class="col-lg-12">
<form:form id="admin-home" action="isValidUser"
...
<form:form id="add-form" action="adminregister" method="post" role="form" style="display: none;">
									<div class="form-group">
									...
									<div class="form-group">
										<input type="text" name="contactnumber" id="contactnumber"
											tabindex="3" class="form-control" placeholder="Contact number">
									</div>
